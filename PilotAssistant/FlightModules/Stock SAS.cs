...
namespace PilotAssistant.FlightModules
{
    ...
    public class Stock_SAS
    {
        ...
        public void drawGUI()
        {
            ...
            {
                if (vesModule.vesselRef.Autopilot.Mode == VesselAutopilot.AutopilotMode.StabilityAssist)
                {
        ...
        private void drawSASPresetWindow(int id)
        {
            ...
            if (GUILayout.Button("+", GUILayout.Width(25)))
                PresetManager.newSASPreset(ref newPresetName, this.vesModule.vesselRef);
        ...
        private void drawRSASPresetWindow(int id)
        {
            ...
            newPresetName = GUILayout.TextField(newPresetName);
            if (GUILayout.Button("+", GUILayout.Width(25)))
                PresetManager.newRSASPreset(ref newPresetName, this.vesModule.vesselRef);
            GUILayout.EndHorizontal();
